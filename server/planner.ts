...
export interface PlanItem { skill_id: string; name: string; kind: 'review' | 'new'; }
 ...
 * Returns the items scheduled and whether a plan was created.
 */
export async function generateWeeklyPlan(
...
): Promise<{ items: PlanItem[]; created: boolean }> {
  ...
  const items = await selectSkillsForChild(supabase, child.id, nowIso);
