...
const ADMIN_NAV: NavItem[] = [
  { label: 'Dashboard', path: '/', icon: Home },
  {
    ...
    icon: BookOpen,
    subItems: [
      { label: 'Curriculum Builder', path: '/subjects', icon: BookOpen },
                  ...
                  >
                    <span
                      className={[
                        ...
                        isSubActive ? 'bg-gradient-to-b from-accent-pink to-accent-coral' : 'bg-transparent',
                      ].join(' ')}
                    />
                    <sub.icon size={15} />
                    {sub.label}
    ...
    <>
      ...
      <aside
        ...
        className={[
          ...
          'bg-gradient-to-b from-nav-from to-nav-to rounded-r-3xl',
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-gradient-to-br from-accent-pink to-accent-coral rounded-xl flex items-center justify-center shadow-lg">
              <GraduationCap size={18} className="text-white" />
            </div>
            <div>
              <p className="font-display text-white font-bold text-sm leading-tight">UnBoxed</p>
                ...
                (() => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={onClose}
                      className={[
                        'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 mb-1',
                        isItemActive
                          ? 'bg-white text-nav-to shadow-md'
